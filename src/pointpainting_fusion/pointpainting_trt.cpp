...
#include "miivii_image_projection_based_fusion/pointpainting_fusion/pointpainting_trt.hpp"

#include <miivii_image_projection_based_fusion/pointpainting_fusion/preprocess_kernel.hpp>
...
{
  vg_ptr_pp_ =
    std::make_unique<miivii_image_projection_based_fusion::VoxelGenerator>(densification_param, config_);
}
  ...
  const sensor_msgs::msg::PointCloud2 & input_pointcloud_msg, const tf2_ros::Buffer & tf_buffer)
{
  ...
  CHECK_CUDA_ERROR(miivii_image_projection_based_fusion::generateVoxels_random_launch(
  ...
  CHECK_CUDA_ERROR(miivii_image_projection_based_fusion::generateBaseFeatures_launch(
  ...
  CHECK_CUDA_ERROR(miivii_image_projection_based_fusion::generateFeatures_launch(
