...
#include "miivii_image_projection_based_fusion/roi_pointcloud_fusion/node.hpp"
...
RCLCPP_COMPONENTS_REGISTER_NODE(miivii_image_projection_based_fusion::RoiPointCloudFusionNode)
