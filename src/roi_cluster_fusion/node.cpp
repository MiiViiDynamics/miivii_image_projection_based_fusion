...
#include "miivii_image_projection_based_fusion/roi_cluster_fusion/node.hpp"
...
RCLCPP_COMPONENTS_REGISTER_NODE(miivii_image_projection_based_fusion::RoiClusterFusionNode)
