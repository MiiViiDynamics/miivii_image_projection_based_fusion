...
#include "miivii_image_projection_based_fusion/segmentation_pointcloud_fusion/node.hpp"
...
RCLCPP_COMPONENTS_REGISTER_NODE(miivii_image_projection_based_fusion::SegmentPointCloudFusionNode)
