...
#include "miivii_image_projection_based_fusion/roi_detected_object_fusion/node.hpp"
...
RCLCPP_COMPONENTS_REGISTER_NODE(miivii_image_projection_based_fusion::RoiDetectedObjectFusionNode)
