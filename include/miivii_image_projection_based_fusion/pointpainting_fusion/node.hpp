...
#ifndef miivii_image_projection_based_fusion__POINTPAINTING_FUSION__NODE_HPP_
#define miivii_image_projection_based_fusion__POINTPAINTING_FUSION__NODE_HPP_
...
protected:
  ...
  std::unique_ptr<miivii_image_projection_based_fusion::PointPaintingTRT> detector_ptr_{nullptr};

  bool out_of_scope(const DetectedObjects & obj);
};
}  // namespace miivii_image_projection_based_fusion
#endif  // miivii_image_projection_based_fusion__POINTPAINTING_FUSION__NODE_HPP_
